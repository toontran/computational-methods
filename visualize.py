...
for matrix_size in [matrix_size_default]:
    ...
    # for matrix_name_prefix in ["Queen_4147", "Flan_1565"]:
        ...
        # for scaling_factor in [2.2361, 0.7071, 0.2236]:
            ...
            # for k in [10, 20, 50, 100, 200, 400, 600, 800, 1000]:
                ...
                # for random_seed in [""]:
                    ...
                    # for name_postfix in [""]:
                            # if matrix_name_prefix == "kernel_torus" and (scaling_factor == 1.0 or scaling_factor == 10.0 ) and "demix" in name_postfix:
                        #     continue
                        # if matrix_name_prefix == "hyperboloid" and (scaling_factor == 1.0 or scaling_factor == 10.0) and "demix" in name_postfix:
                        #     continue

                        # if matrix_name_prefix == "kernel_swissroll" and scaling_factor == 50.0 and "demix" in name_postfix:
                        #     continue
                        # if matrix_name_prefix == "kernel_gausianmixture" and scaling_factor > 5.0:
                        #     continue
                        # if matrix_name_prefix == "hyperboloid" and (scaling_factor == 5.0 ) and "demix" in name_postfix:
                        #     continue
                        # if matrix_name_prefix == "hyperboloid" and (scaling_factor == 50.0 ) and "demix" in name_postfix:
                        #     continue

                        # # withV
                        # if matrix_name_prefix == "kernel_swissroll" and (scaling_factor == 5.0 or scaling_factor == 50.0 ) and "demix" not in name_postfix:
                        #     continue
                        # if matrix_name_prefix == "kernel_swissroll" and (scaling_factor == 1.0 or scaling_factor == 10.0 ) and "demix" in name_postfix:
                        #     continue
                        # if matrix_name_prefix == "kernel_random" and (scaling_factor == 10.0 or scaling_factor == 1.0) and "demix" in name_postfix:
                        #     continue
                        ...
                        for noise in [0.0]:
                            for is_reversed in [False]:
                                for use_true_matrix in [False]:
                                    ...
                                    for reservoir_size in [reservoir_size_default]:
                                    # for reservoir_size in [100]:
                                        ...
                                        for threshold_factor in [1e2]:
                                            ...
                                            for error_kind in ["both"]:
                                                ...
                                                for reservoir_method in ["greedy"]:
                                                    for plot_S_quotient in [True, False]:
