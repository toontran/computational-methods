...
matrices=(
    # "synthetic_1000_20"
#     "bad_matrix_10"
    # "kernel_swissroll_1000_2.0"
    # "kernel_swissroll_1000_1.0"
    # "kernel_swissroll_1000_0.0"

    # "kernel_torus_1000_2.0"
    # "kernel_torus_1000_1.0"
    # "kernel_torus_1000_0.0"

    # "kernel_gaussianmixture_1000_2.0"
    # "kernel_gaussianmixture_1000_1.0"
    # "kernel_gaussianmixture_1000_0.0"

    # "hyperboloid_1000_2.0_0.5_0.0"
    # "hyperboloid_1000_2.0_0.0_0.5"
    # "hyperboloid_1000_2.0_0.5"
    
    # "hyperboloid_1000_2.0_0.001_0.0"
    # "hyperboloid_1000_2.0_0.01_0.0"
    # "hyperboloid_1000_2.0_0.1_0.0"
    # "hyperboloid_1000_2.0_0.0_0.001"
    # "hyperboloid_1000_2.0_0.0_0.01"
    # "hyperboloid_1000_2.0_0.0_0.1"
    # "hyperboloid_1000_2.0_0.001"
    # "hyperboloid_1000_2.0_0.01"
    # "hyperboloid_1000_2.0_0.1"
    # "hyperboloid_1000_1.0_0.05"
    # "hyperboloid_1000_1.0_0.1"
    # "hyperboloid_1000_0.0_0.01"
    # "hyperboloid_1000_0.0_0.05"
    # "hyperboloid_1000_0.0_0.1"
    "kernel_random_1000_2.0"
    "kernel_random_1000_1.5"
    "kernel_random_1000_1.0"
    "kernel_random_1000_0.5"
    "kernel_random_1000_0.0"
    "hyperboloid_1000_2.0"
    "hyperboloid_1000_1.5" 
    "hyperboloid_1000_1.0"
    "hyperboloid_1000_0.5"
    "hyperboloid_1000_0.0"
...
echo "Running isvd_orders_new.py for matrix: $matrix_full_name"
python3 -u isvd_orders_new.py "$matrix_full_name" 2>&1 | tee -a "logs/${matrix_name}.txt"
